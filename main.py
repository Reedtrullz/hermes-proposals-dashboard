...
AGENT_TEMPLATE_DEFS = {
    ...
    "claude_coder": {
        ...
        "system_prompt": "Delegate coding tasks to Claude Code CLI. Use 'claude -p' (print mode) for one-shot non-interactive tasks, 'claude -p --dangerously-skip-permissions --max-turns 20' for fully unattended. Spawn in an isolated worktree, review the diff, run tests, and report via proposal_complete.",
        "provider": "anthropic",
    ...
    "opencode_coder": {
        ...
        "system_prompt": "Delegate coding tasks to OpenCode CLI. Use 'opencode run' for one-shot tasks, interactive PTY for multi-turn. Construct prompts with safety constraints, spawn in an isolated worktree, review the diff, run tests, and report via proposal_complete.",
        "provider": "openrouter",
        "model_name": "auto",
        "tools_allowed": ["comment", "proposal_complete", "proposal_heartbeat", "proposal_block"],
        "monthly_budget_usd": 75,
    ...
    "agy_coder": {
        ...
        "system_prompt": "Delegate coding tasks to Antigravity CLI. Use 'agy exec' for one-shot, background PTY for long tasks. Construct prompts with safety constraints, spawn in an isolated worktree, review the diff, run tests, and report via proposal_complete.",
        "provider": "google",
    ...
    "kilo_coder": {
        ...
        "system_prompt": "Delegate coding tasks to Kilo Code CLI. Binary is 'kilo' (npm: @kilocode/cli). Use 'kilo run --auto' for autonomous CI/CD mode, 'kilo run' for one-shot. Fork of OpenCode, same config format. Spawn in an isolated worktree, review the diff, run tests, and report via proposal_complete. Apache-2.0 open source.",
        "provider": "openrouter",
        "model_name": "auto",
        "tools_allowed": ["comment", "proposal_complete", "proposal_heartbeat", "proposal_block"],
        "monthly_budget_usd": 75,
